...
(cl:defmethod cl:initialize-instance :after ((m <graphNavSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'graphNavSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name go1_autonomy-srv:<graphNavSrv-request> is deprecated: use go1_autonomy-srv:graphNavSrv-request instead.")))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <graphNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:start-val is deprecated.  Use go1_autonomy-srv:start instead.")
  (start m))

(cl:ensure-generic-function 'end-val :lambda-list '(m))
(cl:defmethod end-val ((m <graphNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:end-val is deprecated.  Use go1_autonomy-srv:end instead.")
  (end m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<graphNavSrv-request>)))
  ...
  "go1_autonomy/graphNavSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'graphNavSrv-request)))
  "Returns string type for a service object of type 'graphNavSrv-request"
  "go1_autonomy/graphNavSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <graphNavSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'graphNavSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name go1_autonomy-srv:<graphNavSrv-response> is deprecated: use go1_autonomy-srv:graphNavSrv-response instead.")))

(cl:ensure-generic-function 'plan-val :lambda-list '(m))
(cl:defmethod plan-val ((m <graphNavSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:plan-val is deprecated.  Use go1_autonomy-srv:plan instead.")
  (plan m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<graphNavSrv-response>)))
  ...
  "go1_autonomy/graphNavSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'graphNavSrv-response)))
  "Returns string type for a service object of type 'graphNavSrv-response"
  "go1_autonomy/graphNavSrvResponse")
