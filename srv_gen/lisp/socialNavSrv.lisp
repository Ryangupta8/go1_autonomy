...
(cl:in-package go1_autonomy-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <socialNavSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'socialNavSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name go1_autonomy-srv:<socialNavSrv-request> is deprecated: use go1_autonomy-srv:socialNavSrv-request instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:action-val is deprecated.  Use go1_autonomy-srv:action instead.")
  (action m))

(cl:ensure-generic-function 'goal_pose-val :lambda-list '(m))
(cl:defmethod goal_pose-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:goal_pose-val is deprecated.  Use go1_autonomy-srv:goal_pose instead.")
  (goal_pose m))

(cl:ensure-generic-function 'loc-val :lambda-list '(m))
(cl:defmethod loc-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:loc-val is deprecated.  Use go1_autonomy-srv:loc instead.")
  (loc m))

(cl:ensure-generic-function 'odom-val :lambda-list '(m))
(cl:defmethod odom-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:odom-val is deprecated.  Use go1_autonomy-srv:odom instead.")
  (odom m))

(cl:ensure-generic-function 'laser-val :lambda-list '(m))
(cl:defmethod laser-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:laser-val is deprecated.  Use go1_autonomy-srv:laser instead.")
  (laser m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:time-val is deprecated.  Use go1_autonomy-srv:time instead.")
  (time m))

(cl:ensure-generic-function 'human_poses-val :lambda-list '(m))
(cl:defmethod human_poses-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:human_poses-val is deprecated.  Use go1_autonomy-srv:human_poses instead.")
  (human_poses m))

(cl:ensure-generic-function 'human_vels-val :lambda-list '(m))
(cl:defmethod human_vels-val ((m <socialNavSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:human_vels-val is deprecated.  Use go1_autonomy-srv:human_vels instead.")
  (human_vels m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<socialNavSrv-request>)))
  ...
  "go1_autonomy/socialNavSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'socialNavSrv-request)))
  "Returns string type for a service object of type 'socialNavSrv-request"
  "go1_autonomy/socialNavSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <socialNavSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'socialNavSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name go1_autonomy-srv:<socialNavSrv-response> is deprecated: use go1_autonomy-srv:socialNavSrv-response instead.")))

(cl:ensure-generic-function 'cmd_vel-val :lambda-list '(m))
(cl:defmethod cmd_vel-val ((m <socialNavSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:cmd_vel-val is deprecated.  Use go1_autonomy-srv:cmd_vel instead.")
  (cmd_vel m))

(cl:ensure-generic-function 'cmd_curve-val :lambda-list '(m))
(cl:defmethod cmd_curve-val ((m <socialNavSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:cmd_curve-val is deprecated.  Use go1_autonomy-srv:cmd_curve instead.")
  (cmd_curve m))

(cl:ensure-generic-function 'local_target-val :lambda-list '(m))
(cl:defmethod local_target-val ((m <socialNavSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:local_target-val is deprecated.  Use go1_autonomy-srv:local_target instead.")
  (local_target m))

(cl:ensure-generic-function 'target_id-val :lambda-list '(m))
(cl:defmethod target_id-val ((m <socialNavSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go1_autonomy-srv:target_id-val is deprecated.  Use go1_autonomy-srv:target_id instead.")
  (target_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<socialNavSrv-response>)))
  ...
  "go1_autonomy/socialNavSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'socialNavSrv-response)))
  "Returns string type for a service object of type 'socialNavSrv-response"
  "go1_autonomy/socialNavSrvResponse")
