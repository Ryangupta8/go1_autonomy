...
"""autogenerated by genpy from go1_autonomy/socialNavSrvRequest.msg. Do not edit."""
import codecs
import sys
...
class socialNavSrvRequest(genpy.Message):
  ...
  _type = "go1_autonomy/socialNavSrvRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from go1_autonomy/socialNavSrvResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class socialNavSrvResponse(genpy.Message):
  ...
  _type = "go1_autonomy/socialNavSrvResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class socialNavSrv(object):
  _type          = 'go1_autonomy/socialNavSrv'
