...
#include "go1_autonomy/graphNavSrv.h"
...
using go1_autonomy::graphNavSrv;
using geometry_msgs::TwistStamped;
using geometry::kEpsilon;
using navigation::MotionLimits;
using ros_helpers::InitRosHeader;

const string meps_dir_tmp = ros::package::getPath("go1_autonomy");
const string kAmrlMapsDir = meps_dir_tmp + "/vectormaps";
const string kOpenCVWindow = "Image window";

const string tmp_config = ros::package::getPath("go1_autonomy");
const string config_dir = tmp_config + "/config/navigation.lua";

DEFINE_string(robot_config, config_dir, "Robot config file");
