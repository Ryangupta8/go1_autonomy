...
NavigationParameters = {
  ...
  max_linear_speed = 0.35;--0.175;-- 0.075; -- 0.25; -- 0.175
  max_angular_accel = 0.9;
  max_angular_decel = 0.9;
  max_angular_speed = 0.8; -- 0.25; -- 0.2
  carrot_dist = 1.5;
  system_latency = 0.24;
  obstacle_margin = 0.2;
  num_options = 25; -- 31; -- number of path options
  robot_width = 0.2;
  robot_length = 0.35;
  base_link_offset = 0;
